" celsius.vim -- Vim color scheme.
" Author:      fcpg (n/a) & kyojindev (n/a)
" Webpage:     https://github.com/fcpg & https://github.com/kyojindev
" Description: Dark, warm base16 theme for 256-color terminals based off of fahrenheit.vim
...
let colors_name = "celsius"

if &t_Co >= 256 || has("gui_running")
    hi Normal ctermbg=16 ctermfg=231 cterm=NONE guibg=#000000 guifg=#dddddd gui=NONE
    set background=dark
    hi NonText ctermbg=bg ctermfg=88 cterm=NONE guibg=bg guifg=#870000 gui=NONE
    hi Comment ctermbg=bg ctermfg=95 cterm=NONE guibg=bg guifg=#a8a8a8 gui=NONE
    hi Constant ctermbg=bg ctermfg=231 cterm=NONE guibg=bg guifg=#dddddd gui=NONE
    hi Error ctermbg=88 ctermfg=230 cterm=NONE guibg=#870000 guifg=#ffffd7 gui=NONE
    hi Identifier ctermbg=bg ctermfg=248 cterm=NONE guibg=bg guifg=#dddddd gui=NONE
    ...
    hi Number ctermbg=bg ctermfg=67 cterm=NONE guibg=bg guifg=#d7af87 gui=NONE
    hi Todo ctermbg=bg ctermfg=231 cterm=bold guibg=bg guifg=#d75f00 gui=bold
    ...
    hi TabLineFill ctermbg=235 ctermfg=231 cterm=NONE guibg=#262626 guifg=#dddddd gui=NONE
    ...
    hi helpLeadBlank ctermbg=bg ctermfg=231 cterm=NONE guibg=bg guifg=#dddddd gui=NONE
    hi helpNormal ctermbg=bg ctermfg=231 cterm=NONE guibg=bg guifg=#dddddd gui=NONE
    hi Visual ctermbg=215 ctermfg=16 cterm=NONE guibg=#ffaf5f guifg=#000000 gui=NONE
    hi VisualNOS ctermbg=bg ctermfg=231 cterm=NONE guibg=bg guifg=#dddddd gui=NONE
    hi Pmenu ctermbg=235 ctermfg=248 cterm=NONE guibg=#262626 guifg=#a8a8a8 gui=NONE
    hi PmenuSbar ctermbg=bg ctermfg=231 cterm=NONE guibg=bg guifg=#dddddd gui=NONE
    hi PmenuSel ctermbg=235 ctermfg=221 cterm=NONE guibg=#262626 guifg=#ffd75f gui=NONE
    hi PmenuThumb ctermbg=bg ctermfg=231 cterm=NONE guibg=bg guifg=#dddddd gui=NONE
    ...
    hi SpecialKey ctermbg=bg ctermfg=67 cterm=NONE guibg=bg guifg=#d7af87 gui=NONE
    ...
    hi Directory ctermbg=bg ctermfg=231 cterm=NONE guibg=bg guifg=#dddddd gui=NONE
    ...
    hi ColorColumn ctermbg=bg ctermfg=235 cterm=NONE guibg=#262626 guifg=fg gui=NONE
    hi signColumn ctermbg=bg ctermfg=230 cterm=NONE guibg=bg guifg=#ffffd7 gui=NONE
    hi ErrorMsg ctermbg=88 ctermfg=231 cterm=NONE guibg=#870000 guifg=#dddddd gui=NONE
    ...
    hi Boolean ctermbg=bg ctermfg=67 cterm=NONE guibg=bg guifg=#d7af87 gui=NONE
    hi VimIsCommand ctermbg=bg ctermfg=173 cterm=NONE guibg=bg guifg=#d7875f gui=NONE
    hi VimFunction ctermbg=bg ctermfg=231 cterm=bold guibg=bg guifg=#dddddd gui=bold
    ...
    hi VimMapLhs ctermbg=235 ctermfg=231 cterm=NONE guibg=#262626 guifg=#dddddd gui=NONE
    ...
    hi CtrlPPrtText ctermbg=bg ctermfg=231 cterm=NONE guibg=bg guifg=#dddddd gui=NONE
